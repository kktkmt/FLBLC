...
if __name__ == '__main__':
    ...
    parser.add_argument('--k', metavar='-k', default=1, type=int, help='Number of top-k workers you want')
    ...
    sim = Application(args.num_workers, args.num_rounds, ipfs_hash, args.num_evil, args.k)
    sim.run()